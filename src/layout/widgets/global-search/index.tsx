        ...
        (e) => {
            ...
            const matchRoutes = searchMenuList.filter((menuItem) => {
                ...
                if (isValidElement(menuItem.label)) {
                    labelText = getProperty(menuItem.label.props, 'children', '');
                }
    ...
    return (
        <>
            ...
            >
                ...
                <span className="bg-color-bg-container relative hidden rounded-xs rounded-r-xl px-1.5 py-1 text-xs leading-none group-hover:opacity-100 md:block">
                    &#x2318;
                    <kbd>K</kbd>
                </span>
            </div>
            ...
            <Modal
                ...
                style={
                    isMobile ? { margin: 0, maxWidth: '100%', top: 0, paddingBottom: 0 } : undefined
                }
                styles={{
                    body: {
                        flexGrow: '1',
