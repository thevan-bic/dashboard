        ...
        },
        {
            label: (
                <>
                    ...
                    <span>({t('preferences.theme.builtin.title')})</span>
                </>
            ),
            value: 'blue',
            color: '#1677ff',
                    ...
                    const innerBlock = (
                        ...
                        >
                            <dl className="mb-0">
                                <dd
                                    className={cn(
                                        'relative py-4 px-9 outline-solid outline-1 outline-gray-300 dark:outline-gray-700 rounded-md cursor-pointer',
